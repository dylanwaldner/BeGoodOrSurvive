from neat import adjust_rates_proportional
from neat.neat_predictive import NeatEvolution
...
def generational_driver(votes, max_tokens, temperature, top_p, danger, shared_history, bnn_history, ground_truth_label_list, ethical_ground_truths, gen_loss_history, gen_ethical_history, strong_bnn, config, num_gens, neat_trainer, global_counter, comm):
        ...
        if global_counter in [30, 60, 90, 100]:    
            ...
            if rank == 0:
                ...
                if global_counter == 30:
                    neat_iteration = 1
                elif global_counter == 60:
                    neat_iteration = 2
                elif global_counter == 90:
                    neat_iteration = 3
                else:
            ...
            if rank == 0:
                ...
                iteration_save_path = f"test_predictive_best_architecture_iteration_{neat_iteration}.txt"
                ...
                tradeoff_save_path = f'test_predictive_population_tradeoffs_iteration_{neat_iteration}.json'
                ...
                model_save_path = f"test_predictive_winner_genome_model_iteration_{neat_iteration}.pth"
                torch.save({
    ...
    with torch.no_grad():
        ...
        while global_counter < total_samples:
            ...
            print(f"Test Game {test_sample + 1}, danger = {danger}")
    ...
    if rank == 0:
        ...
        try:
            with open("test_predictive_prod_experiment_summary.json", "w") as summary_file:
                json.dump(overall_summary_serializable, summary_file, indent=4)
            print(f"Experiment summary saved to 'test_predictive_experiment_summary.json'")
        except Exception as e:
